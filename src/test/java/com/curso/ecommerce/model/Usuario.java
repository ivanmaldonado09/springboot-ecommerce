...
public class Usuario {
	@Id
	@GeneratedValue (strategy = GenerationType.IDENTITY) //Esto hace que el campo ID sea autoincremental
	private Integer id;
	...
	@OneToMany(mappedBy = "usuario") //usuario es el campo Usuario usuario en la clase producto
